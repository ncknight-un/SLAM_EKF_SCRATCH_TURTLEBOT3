...
namespace turtlelib
{
    ...
    static_assert(almost_equal(normalize_angle(-std::numbers::pi), std::numbers::pi), "norm_angle failed");     // We are wrapping to not include -pi
    ...
    static_assert(almost_equal(normalize_angle(8.4*std::numbers::pi), 0.4*std::numbers::pi), "norm_angle failed");
    // Case where the angle < -5.0*pi
    static_assert(almost_equal(normalize_angle(-12.4*std::numbers::pi), -0.4*std::numbers::pi), "norm_angle failed");
    // Case -pi/4.0:
    static_assert(almost_equal(normalize_angle(-1*std::numbers::pi/4), -1*std::numbers::pi/4), "norm_angle failed");
    // Case 3*pi/2:
    static_assert(almost_equal(normalize_angle(3*std::numbers::pi/2), -1*std::numbers::pi/2), "norm_angle failed");
    // Case -5*pi/2:
    static_assert(almost_equal(normalize_angle(-5*std::numbers::pi/2), -1*std::numbers::pi/2), "norm_angle failed");
    // Case pi/4.0:
    static_assert(almost_equal(normalize_angle(std::numbers::pi/4), std::numbers::pi/4), "norm_angle failed");
    // Case -3*pi/2:
    static_assert(almost_equal(normalize_angle(-3*std::numbers::pi/2), std::numbers::pi/2), "norm_angle failed");
    // Case 5*pi/2:
    static_assert(almost_equal(normalize_angle(5*std::numbers::pi/2), std::numbers::pi/2), "norm_angle failed");
    // Case -2*pi/5:
    static_assert(almost_equal(normalize_angle(-2*std::numbers::pi/5), -2*std::numbers::pi/5), "norm_angle failed");
    // Case 2pi/5.0:
    static_assert(almost_equal(normalize_angle(2*std::numbers::pi/5), 2*std::numbers::pi/5), "norm_angle failed");
    // Case -6*pi:
    static_assert(almost_equal(normalize_angle(-6*std::numbers::pi), 0.0), "norm_angle failed");
    // Case 5*pi:
    static_assert(almost_equal(normalize_angle(5*std::numbers::pi), std::numbers::pi), "norm_angle failed");
}
#endif
