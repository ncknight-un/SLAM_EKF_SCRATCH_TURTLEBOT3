...
namespace slamlib {
    ...
    public:
        ...
        CircleReg(std::vector<turtlelib::Point2D> points);
        ...
        turtlelib::Point2D computeCentroid(std::vector<turtlelib::Point2D> points);
        ...
        std::vector<turtlelib::Point2D> shiftPoints(turtlelib::Point2D centroid);
        ...
        double computeZ_bar(std::vector<turtlelib::Point2D> shifted_points);
        ...
        std::pair<turtlelib::Point2D, double> computeCircleParams(turtlelib::Point2D centroid);
    ...
    private: 
        ...
        std::vector<turtlelib::Point2D> read_points_;
...
#endif // SLAMLIB_CIRCLE_REG_HPP_INCLUDE_GUARD