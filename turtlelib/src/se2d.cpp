...
namespace turtlelib {
    ...
    Transform2D::Transform2D(Vector2D trans) : trans_{trans}, rot_{0.0} {}
    Transform2D::Transform2D(double radians) : trans_{0.0,0.0}, rot_{radians} {}
    Transform2D::Transform2D(Vector2D trans, double radians) : trans_{trans}, rot_{radians} {}
